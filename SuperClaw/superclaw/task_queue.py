...
class TaskQueue:
    STREAM = "superclaw:review:stream"
    DLQ = "superclaw:review:dlq"
    GROUP = "superclaw-workers"
    ...
    def __init__(
        ...
        self._executor = ThreadPoolExecutor(max_workers=workers, thread_name_prefix="superclaw-worker")
        self._redis = None
