...
from superclaw.diff_parser import parse_unified_diff  # noqa: E402
from superclaw.evaluation_harness import validate_case  # noqa: E402
...
def fetch_diff(repository, pull_request, token=""):
    ...
    headers = {
        ...
        "User-Agent": "superclaw-evaluation-importer",
